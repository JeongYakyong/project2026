...
ax.text(15.4, 0.225, '이 아래는 사실상 평년값 수준', va='bottom', ha='right', fontsize=8.8, color=SOFT)
...
ax.annotate('기온은 가장 오래 신뢰할 수 있다', xy=(7, acc('temp_c')[6]), xytext=(7, 0.955),
...
ax.set_xlabel('며칠 뒤를 예보하는가 (예보 지평)', fontsize=10)
ax.set_ylabel('예보 정보력  (1=완벽 · 0=쓸모없음)', fontsize=10)
ax.set_title('예보는 멀어질수록 쓸모가 사라진다', fontsize=14, fontweight='bold', color=INK, loc='left', pad=30)
